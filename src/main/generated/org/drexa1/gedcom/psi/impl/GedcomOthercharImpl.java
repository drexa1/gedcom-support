...
public class GedcomOthercharImpl extends ASTWrapperPsiElement implements GedcomOtherchar {

  public GedcomOthercharImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GedcomVisitor visitor) {
    visitor.visitOtherchar(this);
  }
