...
public class GedcomAlphanumImpl extends ASTWrapperPsiElement implements GedcomAlphanum {

  public GedcomAlphanumImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GedcomVisitor visitor) {
    visitor.visitAlphanum(this);
  }
